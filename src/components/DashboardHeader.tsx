...
const DashboardHeader = ({ onToggleSidebar }: DashboardHeaderProps) => {
  return (
    <header className="sticky top-0 z-10 flex h-16 w-full items-center justify-between border-b border-b-slate-200 bg-white/80 backdrop-blur-sm px-4">
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-semibold">StockViz Dashboard</h1>
        </div>
      </div>
